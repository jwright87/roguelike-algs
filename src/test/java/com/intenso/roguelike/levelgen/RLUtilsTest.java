...
public class RLUtilsTest {
    ...
    @Test
    public void getRandomInnerPosTest() {
        RLUtils utils = new RLUtils(new Random(8768));
        byte[][] arr = new byte[20][10];
        for (int i = 0; i < 100; i++) {
            int[] pos = utils.getRandomInnerPos(arr);
//            System.out.println(Arrays.toString(pos));
            assertTrue(pos[0] != 0 && pos[0] < 19);
            assertTrue(pos[1] != 0 && pos[1] < 9);
        }
